  ...
  return (
    <DashboardLayout sidebar={<Sidebar navItems={navItems} />}>
      ...
      {loading ? (
        ...
        <p className="text-sm text-gray-400 text-center py-10">Asignación no encontrada.</p>
      ) : (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">{assignment.descripcion}</p>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Donante</p>
              ...
              <div className="bg-orange-50 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="#" className="text-sm text-orange-600 font-medium mt-2 inline-block hover:underline">
                      Ver en mapa →
                    </a>
                  </div>
                </div>
